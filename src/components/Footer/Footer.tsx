    ...
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="social-icons">
          <a href="https://www.facebook.com/travelagencytrc" target="_blank" rel="noopener noreferrer"><FaFacebookF /></a>
          <a href="https://www.instagram.com/toptravel_agency/" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
